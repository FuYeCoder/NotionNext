...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，这是一个教你做副业,寻找副业资源，分享各种互联网资源的网站,Hi，findmoney.club,欢迎来到我的网站：一起findmoney🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FindMoney', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个分享副业各种资源的网站🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://findmoney.com', // 网站地址
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-5394483217779726', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个收集资源，教你做副业的网站', // 站点描述，被notion中的页面描述覆盖
